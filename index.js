...
function _iterableToArrayLimit(arr, i) {
  let _i =
    arr && ((typeof Symbol !== 'undefined' && arr[Symbol.iterator]) || arr['@@iterator']);
...
const customTextProps$1 = styledSystem.system({
  cursor: {
    property: 'cursor'
  },
  fill: {
...
const customBoxProps$1 = styledSystem.system({
  boxSizing: {
    property: 'boxSizing'
  },
  pointerEvents: {
...
const p$1 = b ? Symbol.for('react.suspense') : 60113;
...
const factoryWithTypeCheckers = function (isValidElement, throwOnDirectAccess) {
  ...
  function createEnumTypeChecker(expectedValues) {
    ...
    function validate(props, propName, componentName, location, propFullName) {
      ...
      return new PropTypeError(
        `Invalid ${location} \`${propFullName}\` of value \`${String(propValue)}\` ` +
...
let _templateObject$7;
let _templateObject2$1;
const StyledSpinner = styled__default.default.svg(
  _templateObject$7 ||
...
const Spinner = function Spinner(_ref) {
  ...
  const size = _ref$size === void 0 ? 50 : _ref$size;
  const { color } = _ref;
  const { margin } = _ref;
  const { padding } = _ref;
  const _ref$strokeWidth = _ref.strokeWidth;
  const strokeWidth = _ref$strokeWidth === void 0 ? 6 : _ref$strokeWidth;
...
const Icon = /* #__PURE__ */ React.forwardRef((_ref, ref) => {
  ...
  const fill = _ref$fill === void 0 ? 'gray.7' : _ref$fill;
  const { icon } = _ref;
  const props = _objectWithoutProperties(_ref, [
    'title',
    'size',
  ...
  return /* #__PURE__ */ React__default.default.createElement(
    ...
    /* #__PURE__ */ React__default.default.createElement(
      ...
      title && /* #__PURE__ */ React__default.default.createElement('title', null, title),
...
const generateDynamicColors$1 = function generateDynamicColors(colors) {
  const dynamicColors = {};
  const colorsArray = {};
...
const themeColors = _objectSpread2(
  _objectSpread2({}, colorsPalette),
  generateDynamicColors$1(colorsPalette)
);

const theme = _objectSpread2(
  _objectSpread2({}, baseTheme),
  {},
  {
    colors: themeColors
  }
...
let _templateObject$6;

const ellipsis = function ellipsis(props) {
  return (
    props.ellipsis &&
...
const enhancedHover = styled.css([
  '&:hover{filter:brightness(130%);}&:active{filter:brightness(95%);}'
]);

const filled$1 = function filled(props) {
  return {
    fill: props.color,
    '&:hover': {
      boxShadow: 'medium'
...
const outlined = function outlined(props) {
  let _hover;
  ...
  return {
    ...
    '&:hover':
      ...
      _defineProperty(_hover, 'color', 'white'),
      _defineProperty(_hover, 'fill', 'white'),
      _hover),
    '&:disabled': {
      bg: 'transparent',
      borderColor: 'gray.4',
...
const filled = function filled(props) {
  return {
    fill: props.color,
    minWidth: '40px',
    width: '40px',
...
const circle = function circle(props) {
  return {
    fill: props.color,
    minWidth: '40px',
    width: '40px',
...
const type = function type(props) {
...
let _templateObject$5;
const InnerButton = styled__default.default.button(
  _templateObject$5 ||
...
const Button = /* #__PURE__ */ React.forwardRef((_ref, ref) => {
  ...
  const as = _ref$as === void 0 ? 'button' : _ref$as;
  const { icon } = _ref;
  const _ref$variant = _ref.variant;
  const variant = _ref$variant === void 0 ? 'filled' : _ref$variant;
  const { onClick } = _ref;
  const { children } = _ref;
  const { disabled } = _ref;
  const { loading } = _ref;
...
const DrawerWrapper = styled__default.default(Box)(
  _templateObject$4 ||
    (_templateObject$4 = _taggedTemplateLiteral([
      '\n  display: block;\n  transform: ',
      ';\n'
    ])),
  (props) => (!props.open ? transforms[props.side] : null)
);
...
const DrawerContent = styled__default.default(Box)(
  _templateObject2 ||
  ...
  (props) =>
    (props.side === 'top' || props.side === 'bottom') && props.size ? props.size : '100%',
  (props) =>
...
const Drawer = function Drawer(_ref) {
  const { children } = _ref;
  const { open } = _ref;
  const _ref$side = _ref.side;
  const side = _ref$side === void 0 ? 'top' : _ref$side;
  _ref.onDismiss;
  ...
  const enhancedPlacements = placement
    ? _objectSpread2(
        _objectSpread2({}, defaultPlacements),
        {},
        _defineProperty({}, placement.key, placement.value)
      )
    : defaultPlacements;
  return /* #__PURE__ */ React__default.default.createElement(
    DrawerWrapper,
...
const Drawer$1 = /* #__PURE__ */ React.memo(Drawer);

let _templateObject$3;
const InputField = styled__default.default.input(
  ...
  (_ref) => {
    const { theme } = _ref;
    return '\n    &:focus {\n      border-color:'
      .concat(theme.colors.blue[5], ';\n      background:')
      .concat(theme.colors.blue[0], ';\n    }\n    &:active {\n      border-color:')
      .concat(theme.colors.blue[5], ';\n    }\n    &:disabled {\n      border-color:')
      .concat(theme.colors.gray[4], ';\n      background:')
      .concat(theme.colors.gray[0], ';\n    }\n  ');
  }
);
...
const Overlay = function Overlay(_ref) {
  const { isVisible } = _ref;
  const props = _objectWithoutProperties(_ref, ['isVisible']);
  ...
  return /* #__PURE__ */ React__default.default.createElement(StyledOverlay, {
    key: 'overlay',
...
const TabSwitcher = function TabSwitcher(_ref3) {
  const { children } = _ref3;
  const { defaultTab } = _ref3;

  const _useState = React.useState('a');
  const _useState2 = _slicedToArray(_useState, 2);
  const activeTabId = _useState2[0];
  const setActiveTab = _useState2[1];

  const changeTab = function changeTab(newTabId) {
...
let _templateObject;
const GlobalReset = styled.createGlobalStyle(
  _templateObject ||
...
const customTextProps = styledSystem.system({
  cursor: {
    property: 'cursor'
  },
  fill: {
...
const customBoxProps = styledSystem.system({
  boxSizing: {
    property: 'boxSizing'
  },
  pointerEvents: {
...
const getResponsiveGridByArea = function getResponsiveGridByArea(area, config) {
...
const createGridElement = function createGridElement(as, area, props, gridConfig) {
  return /* #__PURE__ */ React.createElement(
    Box,
    _objectSpread2(
      _objectSpread2({}, getResponsiveGridByArea(area, gridConfig)),
      {},
      {
        as
      },
...
const getRandomElementFromArray = function getRandomElementFromArray(array) {
  return array[Math.floor(Math.random() * array.length)];
};
const getRandomSystemColor = function getRandomSystemColor(shouldBeHex) {
  const choosenColors = [
    'gray',
    'blue',
    'green',
...
const generateDynamicColors = function generateDynamicColors(colors) {
  const dynamicColors = {};
  const colorsArray = {};
  Object.keys(colors).forEach((col) => {
    if (_typeof(colors[col]) === 'object') colorsArray[col] = colors[col];
